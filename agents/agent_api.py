...
# Lazy import for analyze_creative_boldness
        ...
        while True:
            ...
            if action == "start":
                ...
                try:
                    ...
                    creative_boldness_score = strategist_result.get('creative_boldness', 50) if strategist_result else 50
                    
                    # Generate full creative_boldness analysis
                    creative_boldness_full = None
                    try:
                        ...
                        if analyze_creative_boldness and your_analysis and analyst_result:
                            ...
                            creative_boldness_full = await analyze_creative_boldness(
                                your_analysis,
                                competitor_analyses,
                                'fi'  # Default to Finnish
                            )
                            logger.info(f"[WS] Creative boldness analysis generated: score={creative_boldness_full.get('creative_boldness_score', 'N/A')}")
                    except Exception as e:
                        logger.warning(f"[WS] Could not generate creative boldness analysis: {e}")
                        # Fallback to basic structure
                        creative_boldness_full = {
                    ...
                    # Use full object or fallback to score
                    creative_boldness = creative_boldness_full if creative_boldness_full else creative_boldness_score
                    ...
                    await manager.send_json(websocket, {
                        ...
                        "data": {
                            ...
                            # Full your_analysis for deep dive (includes creative_boldness object if available)
