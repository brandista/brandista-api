...
try:
    ...
    NOTIFICATION_WS_AVAILABLE = True
    logger.info("✅ Notification WebSocket imported successfully")
except ImportError as e:
    logger.warning(f"⚠️ Notification WebSocket not available: {e}")
    NOTIFICATION_WS_AVAILABLE = False
...
# ============================================================================
# GROWTH ENGINE 2.0 - NOTIFICATION WEBSOCKET ROUTES
# ============================================================================
...
# ---------------------------------------------------------------------------
# get_website_content — migrated to agents/content_fetch/orchestrator.py
# Re-exported here for backward compatibility (scout_agent imports from main).
# ---------------------------------------------------------------------------
...
# ============================================================================
# OLD WEBSOCKET CHAT (DEPRECATED - NOW USING chat_ws.py ROUTER)
# ============================================================================
