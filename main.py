...
def generate_smart_actions(
    ...
    """Generate comprehensive smart action recommendations"""
    ...
    if score_breakdown.get('security', 0) == 0:
        actions.append({
            "title": "Implement HTTPS immediately",
            "description": "Critical security vulnerability - no SSL certificate",
            "priority": "critical",
            "effort": "low",
            "impact": "critical",
        ...
        actions.append({
            ...
            "description": "Add CSP, X-Frame-Options, and HSTS headers",
            "priority": "high",
            "effort": "low",
            "impact": "high",
    ...
    if score_breakdown.get('mobile', 0) < 5:
        actions.append({
            "title": "Fix mobile responsiveness urgently",
            "description": "Add viewport meta tag and implement responsive design",
            "priority": "critical",
            "effort": "medium",
            "impact": "critical",
            "estimated_score_increase": 15,
    ...
    elif score_breakdown.get('mobile', 0) < 10:
        actions.append({
            "title": "Improve mobile optimization",
            "description": "Enhance responsive design and mobile UX",
            "priority": "high",
            "effort": "medium",
            "impact": "high",
    ...
    if not technical.get('has_analytics'):
        actions.append({
            "title": "Install analytics tools",
            "description": "Set up Google Analytics or Matomo for data-driven decisions",
            "priority": "high",
            "effort": "low",
            "impact": "high",
    ...
    # SEO Actions
    if score_breakdown.get('seo_basics', 0) < 10:
        actions.append({
            "title": "Optimize meta tags and titles",
    ...
    elif score_breakdown.get('seo_basics', 0) < 15:
        actions.append({
            "title": "Enhance SEO structure",
            "description": "Add canonical tags, hreflang, and clean URLs",
            "priority": "medium",
            "effort": "medium",
            "impact": "medium",
            "estimated_score_increase": 5,
    ...
    if content.get('word_count', 0) < 500:
        actions.append({
            ...
            "description": "Website has very little content - develop content plan",
            "priority": "critical",
            "effort": "high",
            "impact": "critical",
    ...
    elif content.get('word_count', 0) < 1500:
        actions.append({
            "title": "Expand content depth",
            "description": "Add more detailed content and value propositions",
            "priority": "high",
            "effort": "medium",
            "impact": "high",
            "estimated_score_increase": 10,
    ...
    if score_breakdown.get('performance', 0) < 3:
        actions.append({
            ...
            "description": "Implement lazy loading, image optimization, and caching",
            "priority": "high",
            "effort": "medium",
            "impact": "high",
            "estimated_score_increase": 5,
    ...
    if score_breakdown.get('social', 0) < 5:
        actions.append({
            ...
            "description": "Create profiles on key platforms and add social links",
            "priority": "medium",
            "effort": "low",
            "impact": "medium",
            "estimated_score_increase": 10,
    ...
    if not technical.get('has_robots_txt'):
        actions.append({
            ...
            "description": "Create robots.txt for better crawl management",
            "priority": "low",
            "effort": "low",
            "impact": "low",
            "estimated_score_increase": 1,
            "category": "technical",
            "estimated_time": "1 hour"
        })
    
    # Content freshness
    if content.get('content_freshness') in ['dated', 'unknown']:
        actions.append({
    ...
    if not content.get('has_blog'):
        actions.append({
            "title": "Launch blog or news section",
            "description": "Create content hub for thought leadership",
            "priority": "medium",
            "effort": "high",
            "impact": "high",
            "estimated_score_increase": 8,
    ...
    if overall_score < 50:
        actions.append({
            ...
            "description": "Add alt texts, ARIA labels, and semantic HTML",
            "priority": "medium",
            "effort": "medium",
            "impact": "medium",
            "estimated_score_increase": 5,
    ...
    # AI-based recommendations from analysis
    if ai_analysis.weaknesses:
        for i, weakness in enumerate(ai_analysis.weaknesses[:3]):
            if len(actions) < 20:  # Limit total actions
                actions.append({
                    "title": f"Address: {weakness[:50]}",
                    "description": weakness,
                    "priority": "high" if i == 0 else "medium",
                    "effort": "medium",
                    "impact": "medium",
                    "estimated_score_increase": 5 - i,
    ...
    # Return top actions (increased from 7 to 15)
    return actions[:15]
