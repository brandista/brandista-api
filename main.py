...
def detect_industry_from_content(domain: str, html: str) -> str:
    """Tunnista toimiala URL:stä ja sisällöstä"""
    domain_lower = domain.lower()
    html_lower = html.lower()
    
    # URL-pohjainen tunnistus
...
def generate_market_trends(url: str = None, html: str = None, tech_stack: Dict = None) -> List[str]:
    """Generoi dynaamiset market trendit perustuen toimialaan ja teknologioihin"""
    
    # Jos ei parametreja, palauta yleiset trendit
    ...
    # Toimialakohtaiset trendit datalla
    industry_trends = {
        'finance': [
    ...
    # Valitse toimialan trendit
    trends = industry_trends.get(industry, industry_trends['general'])
    
    # Lisää teknologiakohtainen trendi jos mahdollista
